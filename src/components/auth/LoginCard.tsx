...
import { Shield, Key, UserPlus, Lock, MapPin } from 'lucide-react';
...
export const LoginCard: React.FC<LoginCardProps> = ({
  ...
  return (
    <div
      className="vajra-panel-elevated relative z-10 max-w-md md:max-w-lg w-full rounded-2xl p-5 sm:p-7 border border-cyan-500/35 shadow-2xl transition-all duration-300 bg-slate-950/80 backdrop-blur-xl"
      id="vajra-auth-card"
    >
